...
@mass_import_router.get("/massexport", tags=["Download"])
def get_expenses_csv(current_user: User = Depends(get_current_user), srvs: MassOperations = Depends(MassOperations)):
